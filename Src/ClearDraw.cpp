...
void ClearDraw::DrawScreen()
{
	sprite->Draw(image, 0, 0, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT);

	GameDevice()->m_pFont->Draw(363, 63, "ƒQ[ƒ€ƒNƒŠƒ„[", 90, RGB(0, 0, 0), 1.0f, "HGP‘n‰pŠpÎß¯Ìß‘Ì");
	GameDevice()->m_pFont->Draw(360, 60, "ƒQ[ƒ€ƒNƒŠƒ„[", 90, RGB(255, 0, 0), 1.0f, "HGP‘n‰pŠpÎß¯Ìß‘Ì");
