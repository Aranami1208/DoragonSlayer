...
namespace {
	...
	const float LifeDistance = 20.0f;
...
{
	mesh = ObjectManager::FindGameObject<WeaponManager>()->MeshList("FireBall")->mesh;	  // WeaponManagerのメッシュを参照する
...
void WeaponFireBall::DrawDepth()
{
	// 影を作らない
}
void WeaponFireBall::DrawScreen()
{
