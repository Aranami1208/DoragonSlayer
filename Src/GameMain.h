...
public:
	...
	MATRIX4X4       m_mView;
	MATRIX4X4       m_mProj;
	MATRIX4X4       m_mDrawView;
	MATRIX4X4       m_mDrawProj;
	VECTOR3         m_vLightDir;	//ディレクショナルライトの方向
	VECTOR3         m_vLightEye;	//ディレクショナルライトのカメラ（視点）位置 // -- 2018.7.28
	MATRIX4X4       m_mLightView[MAX_CASCADE_SHADOW];   //ライトビューマトリックス                   // -- 2018.7.28
	MATRIX4X4       m_mLightProj[MAX_CASCADE_SHADOW];   //ライトプロジェクションマトリックス                   // -- 2020.3.31
