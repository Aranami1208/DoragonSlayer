...
public:
	...
	void    RenderDepth(const MATRIX4X4& mWorld);
	void    RenderDisplaceDepth(const MATRIX4X4& mWorld);
	...
	void    RenderDisplace(Animator* animStatus, const MATRIX4X4& mWorld);
 	void    RenderDepth(Animator* animStatus, const MATRIX4X4& mWorld);
	void    RenderDisplaceDepth(Animator* animStatus, const MATRIX4X4& mWorld);

public:
	// スタティックメッシュ	レンダリング
	void    Render(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDisplace(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDepth(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
	void    RenderDisplaceDepth(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);

private:
	// スタティックメッシュ	レンダリング
	void    RenderStatic(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDisplaceStatic(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderStaticDepth(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
	void    RenderDisplaceStaticDepth(const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);

public:
	// スキンメッシュ   レンダリング
	void    Render(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderSkin(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
	void    RenderSkinDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);

	void    MakeBoneMatrix(Animator* animStatus, MATRIX4X4* mat, const CFbxMeshArray& _mesh);

private:
	// スキンメッシュ   レンダリング
	void    RenderDisplaceSkin(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDisplace(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    RenderDisplaceSkinDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
	void    RenderDisplaceDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);

	void    Draw(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    DrawDisplace(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye, const MATRIX4X4 mLightView[], const MATRIX4X4 mLightProj[]);
	void    DrawDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
	void    DrawDisplaceDepth(Animator* animStatus, const MATRIX4X4& mWorld, const MATRIX4X4& mView, const MATRIX4X4& mProj, const VECTOR3& vLight, const VECTOR3& vEye);
